...
const TableComponent = () => {
  ...
  return (
    <>
      <div className="flex flex-col mt-9 border border-cyan-100 rounded">
        {cryptoData ? (
              ...
              {cryptoData.map((data) => {
                return (
                  <tr
                    ...
                    hover:bg-sky-600 last:border-b-0
                    "
                  >
                    <td className="py-4 flex items-center uppercase">
                      ...
                      <img src={data.image} alt={data.name}  className="w-[1.2rem] h-[1.2rem] mx-1.5"/>
                    </td>
                    ...
                    <td className="py-4">{Number(data.price_change_percentage_24h_in_currency).toFixed(2)}</td>
